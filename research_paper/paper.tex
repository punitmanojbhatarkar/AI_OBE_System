...
% ============================================================
\author{
\IEEEauthorblockN{1\textsuperscript{st} Punit Bhatarkar\textsuperscript{*}}
\IEEEauthorblockA{\textit{Dept. of CSE (Data Science)} \\
\textit{MITAOE}\\
Pune, India \\
*Corresponding Author: punitbhatarkar650@gmail.com}
\and
...
We evaluated the software across multiple departments at the MIT Academy of Engineering during the 2025--26 academic year.
...
\subsection{Accuracy and Expert Validation}
An expert panel of five senior faculty members audited the AI outputs. The Bloom's Taxonomy validation achieved a 91\% accuracy rate without requiring any human modification. The CO-PO mapping generation secured a 78\% acceptance rate, with manual revisions largely confined to highly specialized Program Specific Outcomes (PSOs). Faculty spent an average of only 8 minutes per course reviewing the AI's output, preserving the extensive time-saving benefits of the system.

\subsection{System Usability Score}
We asked our users to fill out a standard System Usability Scale (SUS) form. Our system scored a mean of \textbf{81.5 $\pm$ 2.4 / 100}. This rating falls into the "Excellent" category, proving that the user interface is easy to understand and much better than older college management portals ($p < 0.01$).
